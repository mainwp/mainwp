        ...
        jQuery.post(ajaxurl, data, function (response) {
            ...
            if (response) {
                if (response.result == 'SUCCESS') {
                    ...
                    msg = __('Extension deactivated successfully.');
                    if (whatAct == 'active') {
                        msg = __('Extension activated successfully.');
                    } else if (whatAct == 'remove') {
                        msg = __('Extension removed successfully.');
                    }
...
mainwp_extension_grab_org_extensions = function () {
    ...
    statusEl.removeClass('yellow');
    statusEl.show();
    statusEl.html('<i class="notched circle loading icon"></i> ' + __('Running. Please wait...'));
