...
class MainWP_DB extends MainWP_DB_Base {
	...
	/**
	 * Get child sites by IDs.
	 *
	 * @param array $ids    Child sites IDs.
	 * @param int   $userId User ID.
	 *
	 * @return object|null Database query result or null on failure.
	 */
	 ...
	 *
	 * @param int   $websiteid Child site ID.
	 * @param array $stats     Updated Child site Update status.
	 *
	 * @return int|bool Number of rows effected in update or false on failure.
	 */
	...
	/**
	 * Get websites with bad Site health score.
	 *
	 * @param int $globalThreshold Site health threshold.
	 *
	 * @return array An array containg the list of sites with bad Site health score.
	 */
