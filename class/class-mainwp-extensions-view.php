...
class MainWP_Extensions_View {
	...
	public static function render_side_box( $mainwp_api_key ) {
		...
		<div class="ui message info">
			<?php echo sprintf( __( 'Not sure how to find your MainWP Master API Key? %1$sClick here to get it.%2$s', 'mainwp' ), '<a href="https://mainwp.com/my-account/my-api-keys/" target="_blank">', '</a>' ); ?>
		</div>
		<?php endif; ?>
		<div class="ui form" id="mainwp-extensions-api-fields">
			<div class="field">
						<label><?php esc_html_e( 'Enter your MainWP Master API Key.', 'mainwp' ); ?></label>
					</div>
					<div class="field">
				<div class="ui input fluid">
			...
			<div class="field">
				<div class="ui checkbox">
					...
					<label for="extensions_api_savemylogin_chk"><small><?php esc_html_e( 'Remember MainWP Master API Key', 'mainwp' ); ?></small></label>
				</div>
			</div>
		</div>
		<div class="ui compact hidden divider"></div>
		<div class="ui message mainwp-extensions-api-loading" style="display: none"></div>
		<input type="button" class="ui fluid button" id="mainwp-extensions-savelogin" value="<?php esc_attr_e( 'Validate my MainWP Master API Key', 'mainwp' ); ?>">
