    ...
    public static function get_available_extensions( $types = array( 'free', 'pro' ), $ext_grouped = array() ) { //phpcs:ignore -- NOSONAR - complex.
        ...
        $all_exts   = array(
            ...
            array(
                ...
                'title'                => 'MainWP Solid Security Extension',
                'desc'                 => 'The Solid Security Extension combines the power of your MainWP Dashboard with the popular Solid Security Plugin. It allows you to manage Solid Security plugin settings directly from your dashboard. Requires MainWP Dashboard plugin.',
                ...
                'group'                => array( 'security' ),
                'privacy'              => 2,
                'integration'          => 'Solid Security Plugin',
                'integration_url'      => 'https://ithemes.com/',
                'integration_owner'    => 'Liquid Web, LLC',
                'integration_owner_pp' => 'https://www.liquidweb.com/about-us/policies/privacy-policy/',
            ),
