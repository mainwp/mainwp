...
class MainWP_Hooks {
	...
	public function mainwp_do_meta_boxes( $postpage ) {
         ...
         *
         * @since 3.2.2
         * @param array $params site data fields: url, name, wpadmin, unique_id, groupids, ssl_verify, ssl_version, http_user, http_pass
         * @param int $params['websiteid'] to edit site - deprecated
         * @return array 
         * 
         */                
		...
		if ( ! MainWP_Utility::can_edit_website( $website ) ) {
			return 0;
                ...
                // update unique Id on child site
                if ($uniqueId !== null) {
                    try {
