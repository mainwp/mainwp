...
class MainWP_Monitoring_Sites_List_Table extends MainWP_Manage_Sites_List_Table { // phpcs:ignore Generic.Classes.OpeningBraceSameLine.ContentAfterBrace -- NOSONAR.
        ...
        <?php if ( MainWP_Utility::show_mainwp_message( 'notice', 'mainwp-monitoring-info-message' ) ) : ?>
            <div class="ui info message">
                ...
                <?php
                    ...
                    printf( esc_html__( 'If you need further guidance, feel free to visit our %1$sKnowledge Base%2$s or reach out to support.', 'mainwp' ), '<a href="https://docs.mainwp.com/sites/management/manage-child-sites#uptime-monitoring" target="_blank">', '</a> <i class="external alternate icon"></i>' ); // NOSONAR - noopener - open safe.
                ?>
                    </div>
            </div>
        <?php endif; ?>
    ...
    public function column_site( $website ) {
        ...
        <?php endif; ?>
        <?php
        if ( empty( $website['issub'] ) ) { // primary monitor.
            $mo_st_id = $website['id'];
            ?>
