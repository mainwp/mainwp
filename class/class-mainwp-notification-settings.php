...
class MainWP_Notification_Settings {
	...
	public static function emails_general_settings_handle() {
		if ( isset( $_POST['submit'] ) && isset( $_POST['wp_nonce'] ) && wp_verify_nonce( $_POST['wp_nonce'], 'SettingsEmail' ) ) {
	...
	public function render_all_settings( $updated ) {
		...
		<?php if ( $updated ) : ?>
			...
			<div class="ui info message">
				<?php esc_html_e( 'Email notifications sent from MainWP Dashboard are listed below. Click on an email to configure it.', 'mainwp' ); ?>
			</div>
	...
	public static function get_notification_types( $type = '' ) {
		$types = array(
			'daily_digets' => __( 'Daily Digets Email', 'mainwp' ),
