...
class MainWP_System {
	...
	public function __construct( $mainwp_plugin_file ) {
		...
		add_filter( 'mainwp-extension-enabled-check', array(
			MainWP_Extensions::getClassName(),
			'isExtensionEnabled'
		) );
	...
	public function after_extensions_plugin_row( $plugin_slug, $plugin_data, $status ) {
        ...
        <tr class="plugin-update-tr active" slug="<?php echo esc_attr( $slug ); ?>">
            <td colspan="3" class="plugin-update colspanchange">
                <div class="update-message api-deactivate">
					<?php echo $notice_html; ?>
                    <span class="mainwp-right"><a href="#" class="mainwp-activate-notice-dismiss"><i
	...
	public function admin_notices() {
			...
			if ( MainWP_Utility::showMainWPMessage( 'notice', 'phpver_5_5' ) ) {
                ...
                <div class="mainwp-notice-wrap mainwp-notice mainwp-notice-red" style="margin-top: 2em">
                    ...
                    <span class="mainwp-right"><a class="mainwp-notice-dismiss" notice-id="phpver_5_5"
                                    ...
                                    class="fa fa-times-circle"></i> <?php esc_html_e( 'Dismiss', 'mainwp' ); ?></a></span>
                </div>
				<?php
			}
		}
			...
			if ( self::isMainWP_Pages() ) {
				if ( ! MainWP_Plugins::checkAutoUpdatePlugin( 'mainwp-child/mainwp-child.php' ) ) {
                    ...
                    <div id="" class="mainwp-events-notice mainwp-notice mainwp-notice-red fade">
                        <span class="mainwp-right"><a class="mainwp-events-notice-dismiss" notice="trust_child"
                                                      style="text-decoration: none;" href="#"><i
                                        class="fa fa-times-circle"></i> <?php esc_html_e( 'Dismiss', 'mainwp' ); ?></a></span>
                        ...
                        &nbsp;<a id="mainwp_btn_autoupdate_and_trust" class="button-primary"
                                 href="#"><?php esc_html_e( 'Turn on', 'mainwp' ); ?></a>
                        &nbsp;<a class="button" href="//docs.mainwp.com/setting-mainwp-as-a-trusted-plugin/"
                                 target="_blank"><?php esc_html_e( 'Learn more', 'mainwp' ); ?></a>
                    </div>
					<?php
		...
		if ( $display_request1 ) {
            ...
            <div class="mainwp-events-notice updated fade">
                <p>
                    <span class="mainwp-right"><a class="mainwp-events-notice-dismiss" notice="request_reviews1"
                                                  style="text-decoration: none;" href="#"><i
                                    class="fa fa-times-circle"></i> <?php esc_html_e( 'Dismiss', 'mainwp' ); ?></a></span>
                    <span style="font-size: 14px;">
						...
						<a href="https://wordpress.org/support/view/plugin-reviews/mainwp#postform" target="_blank"
                           class="button mainwp-upgrade-button"><?php esc_html_e( 'Ok, you deserve!', 'mainwp' ); ?>
                            <i class="fa fa-star"></i>
							<i class="fa fa-star"></i>
							<i class="fa fa-star"></i>
							<i class="fa fa-star"></i>
							<i class="fa fa-star"></i>
						</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="" class="button mainwp-events-notice-dismiss"
                                                        notice="request_reviews1"><?php esc_html_e( 'Nope, maybe later.', 'mainwp' ); ?></a>
						<a href="" class="button mainwp-events-notice-dismiss"
                           notice="request_reviews1_forever"><?php esc_html_e( 'I already did.', 'mainwp' ); ?></a>
					</span>
                </p>
            </div>
		<?php } else if ( $display_request2 ) { ?>
            <div class="mainwp-events-notice updated fade">
                <p>
                    <span class="mainwp-right"><a class="mainwp-events-notice-dismiss" style="text-decoration: none;"
                                                  notice="request_reviews2" href="#"><i
                                    class="fa fa-times-circle"></i> <?php esc_html_e( 'Dismiss', 'mainwp' ); ?></a></span>
                    <span style="font-size: 14px;">
						...
						<?php esc_html_e( '~ Dennis', 'mainwp' ); ?><br/><br/>
						<a href="https://wordpress.org/support/view/plugin-reviews/mainwp#postform" target="_blank"
                           class="button mainwp-upgrade-button">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="" class="button mainwp-events-notice-dismiss"
                           notice="request_reviews2"><?php esc_html_e( 'Nope, maybe later.', 'mainwp' ); ?></a>
						<a href="" class="button mainwp-events-notice-dismiss"
                           notice="request_reviews2_forever"><?php esc_html_e( 'I already did.', 'mainwp' ); ?></a>
					</span>
                </p>
            </div>
			<?php
	...
	function print_updates_array_text_lines( $array, $backupChecks ) {
		$output = '';
				...
				if ( ! empty( $plugin_automaticDailyUpdate ) ) {
					if ( ( count( $pluginsNewUpdate ) != 0 ) || ( count( $pluginsToUpdate ) != 0 )
						...
						if ( $text_format ) {
							...
							$mail .= "\r\n";
							$mail .= $this->print_updates_array_text_lines( $pluginsNewUpdate, null );
							$mail .= $this->print_updates_array_text_lines( $pluginsToUpdate, $sitesCheckCompleted );
							$mail .= $this->print_updates_array_text_lines( $notTrustedPluginsNewUpdate, null );
							$mail .= $this->print_updates_array_text_lines( $notTrustedPluginsToUpdate, null );
							$mail .= "\r\n";
						} else {
				...
				if ( ! empty( $theme_automaticDailyUpdate ) ) {
					if ( ( count( $themesNewUpdate ) != 0 ) || ( count( $themesToUpdate ) != 0 )
						...
						if ( $text_format ) {
							...
							$mail .= "\r\n";
							$mail .= $this->print_updates_array_text_lines( $themesNewUpdate, null );
							$mail .= $this->print_updates_array_text_lines( $themesToUpdate, $sitesCheckCompleted );
							$mail .= $this->print_updates_array_text_lines( $notTrustedThemesNewUpdate, null );
							$mail .= $this->print_updates_array_text_lines( $notTrustedThemesToUpdate, null );
							$mail .= "\r\n";
						} else {
				...
				if ( ! empty( $mainwpAutomaticDailyUpdate ) ) {
					if ( ( count( $coreNewUpdate ) != 0 ) || ( count( $coreToUpdate ) != 0 ) || ( count( $ignoredCoreNewUpdate ) != 0 ) || ( count( $ignoredCoreToUpdate ) != 0 ) ) {
						...
						if ( $text_format ) {
							...
							$mail .= "\r\n";
							$mail .= $this->print_updates_array_text_lines( $coreNewUpdate, null );
							$mail .= $this->print_updates_array_text_lines( $coreToUpdate, $sitesCheckCompleted );
							$mail .= $this->print_updates_array_text_lines( $ignoredCoreNewUpdate, null );
							$mail .= $this->print_updates_array_text_lines( $ignoredCoreToUpdate, null );
							$mail .= "\r\n";
						} else {
					...
					if ( $email != false && $email != '' ) {
						if ( $text_format ) {
							$mail = 'We noticed the following updates are available on your MainWP Dashboard. (' . site_url() . ')' . "\r\n"
							        . $mail . '
                                     Update Key:' . "\r\n" .
							        'Trusted - will be updated within 24 hours.' . "\r\n" .
							        'Not Trusted - you will need to log into your MainWP Dashboard and update.' . "\r\n" .
							        ...
							        'https://mainwp.com/help/docs/managing-plugins-with-mainwp/plugins-auto-updates/' . "\r\n" .
							        'https://mainwp.com/help/docs/managing-themes-with-mainwp/themes-auto-updates/' . "\r\n" .
							        'https://mainwp.com/help/docs/auto-update-wordpress-core/' . "\r\n";
						} else {
	...
	public static function add_sub_left_menu( $title, $parent_key, $slug, $href, $icon = '', $desc = '' ) {
		...
		if ( ! empty( $slug ) ) {
			$_mainwp_menu_active_slugs[ $slug ] = $slug;
		} // to get active menu
	}
	...
	public static function add_sub_sub_left_menu( $title, $parent_key, $slug, $href, $right = '' ) {
		...
		if ( ! empty( $slug ) ) {
			$_mainwp_menu_active_slugs[ $slug ] = $parent_key;
		} // to get active menu
	}
        ...
        <div id="mainwp-installation-warning" class="mainwp-notice mainwp-notice-red">
            ...
            <div style="text-align: center">
                <a href="#" class="button button-primary"
                   id="remove-mainwp-installation-warning"><?php esc_html_e( 'I have read the warning and I want to proceed', 'mainwp' ); ?></a>
            </div>
        </div>
		<?php
	}
	...
	function admin_init() {
		...
		if ( isset( $_GET['page'] ) && ( $_GET['page'] == 'PluginsManage' || $_GET['page'] == 'ThemesManage' ) ) {
			wp_enqueue_script( 'mainwp-fixedtable', MAINWP_PLUGIN_URL . 'js/tableHeadFixer.js', array(
				'jquery',
				'jquery-ui-core'
			), $this->current_version );
		}
...
//					exit;
	...
	public static function getHelpContent( $tabId ) {
		...
		if ( 1 == $tabId ) {
            ...
            <p>If you are having issues with getting started with the MainWP plugin, please review following help
                documents</p>
            <a href="<?php echo $documentation; ?>docs/set-up-the-mainwp-plugin/" target="_blank"><i
                        class="fa fa-book"></i> Set up the MainWP Plugin</a><br/>
            <a href="<?php echo $documentation; ?>docs/set-up-the-mainwp-plugin/install-mainwp-dashboard/"
               target="_blank"><i class="fa fa-book"></i> Install MainWP Dashboard</a><br/>
            <a href="<?php echo $documentation; ?>docs/set-up-the-mainwp-plugin/install-mainwp-child/"
               target="_blank"><i class="fa fa-book"></i> Install MainWP Child</a><br/>
            <a href="<?php echo $documentation; ?>docs/set-up-the-mainwp-plugin/quick-setup-wizard/" target="_blank"><i
                        class="fa fa-book"></i> Quick Setup Wizard</a><br/>
            <a href="<?php echo $documentation; ?>docs/set-up-the-mainwp-plugin/set-unique-security-id/"
               target="_blank"><i class="fa fa-book"></i> Set Unique Security ID</a><br/>
            <a href="<?php echo $documentation; ?>docs/set-up-the-mainwp-plugin/add-site-to-your-dashboard/"
               target="_blank"><i class="fa fa-book"></i> Add a Site to your Dashboard</a><br/>
            <a href="<?php echo $documentation; ?>docs/set-up-the-mainwp-plugin/mainwp-dashboard-settings/"
               target="_blank"><i class="fa fa-book"></i> MainWP Dashboard Settings</a><br/>
            <a href="<?php echo $documentation; ?>docs/set-up-the-mainwp-plugin/add-site-to-your-dashboard/import-sites/"
               target="_blank"><i class="fa fa-book"></i> Import Sites</a><br/>
		<?php } else if ( 2 == $tabId ) { ?>
            <h3>First Steps with Extensions</h3>
            <p>If you are having issues with getting started with the MainWP extensions, please review following help
                documents</p>
            <a href="<?php echo $documentation; ?>docs/what-are-mainwp-extensions/" target="_blank"><i
                        class="fa fa-book"></i> What are the MainWP Extensions</a><br/>
            <a href="<?php echo $documentation; ?>docs/what-are-mainwp-extensions/order-extensions/" target="_blank"><i
                        class="fa fa-book"></i> Order Extension(s)</a><br/>
            <a href="<?php echo $documentation; ?>docs/what-are-mainwp-extensions/my-downloads-and-api-keys/"
               target="_blank"><i class="fa fa-book"></i> My Downloads and API Keys</a><br/>
            <a href="<?php echo $documentation; ?>docs/what-are-mainwp-extensions/install-extensions/"
               target="_blank"><i class="fa fa-book"></i> Install Extension(s)</a><br/>
            <a href="<?php echo $documentation; ?>docs/what-are-mainwp-extensions/activate-extensions-api/"
               target="_blank"><i class="fa fa-book"></i> Activate Extension(s) API</a><br/>
            <a href="<?php echo $documentation; ?>docs/what-are-mainwp-extensions/updating-extensions/" target="_blank"><i
                        class="fa fa-book"></i> Updating Extension(s)</a><br/>
            <a href="<?php echo $documentation; ?>docs/what-are-mainwp-extensions/remove-extensions/" target="_blank"><i
                        class="fa fa-book"></i> Remove Extension(s)</a><br/><br/>
            <a href="<?php echo $documentation; ?>/category/mainwp-extensions/" target="_blank"><i
                        class="fa fa-book"></i> Help Documenation for all MainWP Extensions</a>
		<?php } else if ( 3 == $tabId ) { ?>
            <h3>User Interface</h3>
            <p>If you need help with understanding the MainWP User Interface, please review following help documents</p>
            <a href="<?php echo $documentation; ?>docs/understanding-mainwp-dashboard-user-interface/"
               target="_blank"><i class="fa fa-book"></i> Understanding MainWP Dashboard User Interface</a><br/>
            <a href="<?php echo $documentation; ?>docs/understanding-mainwp-dashboard-user-interface/mainwp-navigation/"
               target="_blank"><i class="fa fa-book"></i> MainWP Navigation</a><br/>
            <a href="<?php echo $documentation; ?>docs/understanding-mainwp-dashboard-user-interface/screen-options/"
               target="_blank"><i class="fa fa-book"></i> Screen Options</a><br/>
            <a href="<?php echo $documentation; ?>docs/understanding-mainwp-dashboard-user-interface/mainwp-dashboard/"
               target="_blank"><i class="fa fa-book"></i> MainWP Dashboard</a><br/>
            <a href="<?php echo $documentation; ?>docs/understanding-mainwp-dashboard-user-interface/mainwp-tables/"
               target="_blank"><i class="fa fa-book"></i> MainWP Tables</a><br/>
            <a href="<?php echo $documentation; ?>docs/understanding-mainwp-dashboard-user-interface/individual-child-site-mode/"
               target="_blank"><i class="fa fa-book"></i> Individual Child Site Mode</a><br/>
            <a href="<?php echo $documentation; ?>docs/understanding-mainwp-dashboard-user-interface/select-sites-metabox/"
               target="_blank"><i class="fa fa-book"></i> Select Sites Metabox</a><br/>
		<?php } else if ( 4 == $tabId ) { ?>
            <h3>Manage Updates</h3>
            <p>If you need help with managing updates, please review following help documents</p>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/update-plugins/" target="_blank"><i
                        class="fa fa-book"></i> Update Plugins</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/plugins-auto-updates/"
               target="_blank"><i class="fa fa-book"></i> Plugins Auto Updates</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/ignore-plugin-updates/"
               target="_blank"><i class="fa fa-book"></i> Ignore Plugin Updates</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/update-themes/" target="_blank"><i
                        class="fa fa-book"></i> Update Themes</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/themes-auto-updates/"
               target="_blank"><i class="fa fa-book"></i> Themes Auto Updates</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/ignore-theme-updates/"
               target="_blank"><i class="fa fa-book"></i> Ignore Theme Updates</a><br/>
            <a href="<?php echo $documentation; ?>docs/update-wordpress-core/" target="_blank"><i
                        class="fa fa-book"></i> Update WordPress Core</a><br/>
            <a href="<?php echo $documentation; ?>docs/auto-update-wordpress-core/" target="_blank"><i
                        class="fa fa-book"></i> Auto Update WordPress Core</a><br/>
            <a href="<?php echo $documentation; ?>docs/ignore-wordpress-core-update/" target="_blank"><i
                        class="fa fa-book"></i> Ignore WordPress Core Update</a><br/>
		<?php } else if ( 5 == $tabId ) { ?>
            <h3>Manage Sites</h3>
            <p>If you need help with understanding sites management, please review following help documents</p>
            <a href="<?php echo $documentation; ?>docs/manage-child-sites/" target="_blank"><i class="fa fa-book"></i>
                Manage Child Sites</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-child-sites/access-child-site-wp-admin/"
               target="_blank"><i class="fa fa-book"></i> Access Child Site WP Admin</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-child-sites/synchronize-a-child-site/" target="_blank"><i
                        class="fa fa-book"></i> Synchronize a Child Site</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-child-sites/edit-a-child-site/" target="_blank"><i
                        class="fa fa-book"></i> Edit a Child Site</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-child-sites/reconnect-a-child-site/" target="_blank"><i
                        class="fa fa-book"></i> Reconnect a Child Site</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-child-sites/delete-a-child-site/" target="_blank"><i
                        class="fa fa-book"></i> Delete a Child Site</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-child-sites/security-issues/" target="_blank"><i
                        class="fa fa-book"></i> Security Issues</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-child-sites/manage-child-site-groups/" target="_blank"><i
                        class="fa fa-book"></i> Manage Child Site Groups</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-child-sites/manage-child-site-notes/" target="_blank"><i
                        class="fa fa-book"></i> Manage Child Site Notes</a><br/>
		<?php } else if ( 6 == $tabId ) { ?>
            <h3>Manage Posts</h3>
            <p>If you need help with understanding posts management, please review following help documents</p>
            <a href="<?php echo $documentation; ?>docs/manage-posts/" target="_blank"><i class="fa fa-book"></i> Manage
                Posts</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-posts/create-a-new-post/" target="_blank"><i
                        class="fa fa-book"></i> Create a New Post</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-posts/edit-an-existing-post/" target="_blank"><i
                        class="fa fa-book"></i> Edit an Existing Post</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-posts/change-status-of-an-existing-post/" target="_blank"><i
                        class="fa fa-book"></i> Change Status of an Existing Post</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-posts/view-an-existing-post/" target="_blank"><i
                        class="fa fa-book"></i> View an Existing Post</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-posts/delete-posts/" target="_blank"><i
                        class="fa fa-book"></i> Delete Post(s)</a><br/>
		<?php } else if ( 7 == $tabId ) { ?>
            <h3>Manage Pages</h3>
            <p>If you need help with understanding pages management, please review following help documents</p>
            <a href="<?php echo $documentation; ?>docs/manage-pages/" target="_blank"><i class="fa fa-book"></i> Manage
                Pages</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-pages/create-a-new-page/" target="_blank"><i
                        class="fa fa-book"></i> Create a New Page</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-pages/edit-a-page/" target="_blank"><i
                        class="fa fa-book"></i> Edit a Page</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-pages/view-an-existing-page/" target="_blank"><i
                        class="fa fa-book"></i> View an Existing Page</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-pages/delete-pages/" target="_blank"><i
                        class="fa fa-book"></i> Delete Page(s)</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-pages/restore-pages/" target="_blank"><i
                        class="fa fa-book"></i> Restore Page(s)</a><br/>
		<?php } else if ( 8 == $tabId ) { ?>
            <h3>Manage Plugins</h3>
            <p>If you need help with understanding plugins management, please review following help documents</p>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/" target="_blank"><i
                        class="fa fa-book"></i> Managing Plugins with MainWP</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/install-plugins/" target="_blank"><i
                        class="fa fa-book"></i> Install Plugin(s)</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/activate-plugins/"
               target="_blank"><i class="fa fa-book"></i> Activate Plugins</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/deactivate-plugins/"
               target="_blank"><i class="fa fa-book"></i> Deactivate Plugins</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/delete-plugins/" target="_blank"><i
                        class="fa fa-book"></i> Delete Plugins</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/update-plugins/" target="_blank"><i
                        class="fa fa-book"></i> Update Plugins</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-plugins-with-mainwp/plugins-auto-updates/"
               target="_blank"><i class="fa fa-book"></i> Plugins Auto Updates</a><br/>
		...
		<?php } else if ( 9 == $tabId ) { ?>
            ...
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/" target="_blank"><i
                        class="fa fa-book"></i> Managing Themes with MainWP</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/install-themes/" target="_blank"><i
                        class="fa fa-book"></i> Install Themes</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/activate-themes/" target="_blank"><i
                        class="fa fa-book"></i> Activate Themes</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/delete-themes/" target="_blank"><i
                        class="fa fa-book"></i> Delete Themes</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/abandoned-themes/" target="_blank"><i
                        class="fa fa-book"></i> Abandoned Themes</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/update-themes/" target="_blank"><i
                        class="fa fa-book"></i> Update Themes</a><br/>
            <a href="<?php echo $documentation; ?>docs/managing-themes-with-mainwp/themes-auto-updates/"
               target="_blank"><i class="fa fa-book"></i> Themes Auto Updates</a><br/>
		...
		<?php } else if ( 10 == $tabId ) { ?>
            ...
            <a href="<?php echo $documentation; ?>docs/manage-users/" target="_blank"><i class="fa fa-book"></i> Manage
                Users</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-users/create-a-new-user/" target="_blank"><i
                        class="fa fa-book"></i> Create a New User</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-users/edit-an-existing-user/" target="_blank"><i
                        class="fa fa-book"></i> Edit an Existing User</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-users/change-a-role-for-child-site-users/"
               target="_blank"><i class="fa fa-book"></i> Change a Role for Child Site User(s)</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-users/bulk-update-users-passwords/" target="_blank"><i
                        class="fa fa-book"></i> Bulk Update Users Passwords</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-users/bulk-update-administrator-passwords/"
               target="_blank"><i class="fa fa-book"></i> Bulk Update Administrator Passwords</a><br/>
            <a href="<?php echo $documentation; ?>docs/manage-users/delete-users/" target="_blank"><i
                        class="fa fa-book"></i> Delete User(s)</a><br/>
		<?php } else if ( 11 == $tabId ) { ?>
            <h3>Troubleshooting</h3>
            <p>Troubleshooting help documentation</p>
            <a href="<?php echo $documentation; ?>category/troubleshooting/adding-a-child-site-issues/" target="_blank"><i
                        class="fa fa-book"></i> Adding a Child Site Issues</a><br/>
            <a href="<?php echo $documentation; ?>category/troubleshooting/activating-and-updating-mainwp-extensions-issues/"
               target="_blank"><i class="fa fa-book"></i> Activating and Updating MainWP Extensions Issues</a><br/>
			<?php
		}
		$output = ob_get_clean();
        ...
        <div id="mainwp-sites-menu" style="direction: rtl;">
            <div style="direction: ltr;">
                ...
                <div id="mainwp-sites-menu-filter">
                    <input id="mainwp-fly-manu-filter" style="margin-top: .5em; width: 100%;" type="text" value=""
                           placeholder="<?php esc_attr_e( 'Type here to filter sites', 'mainwp' ); ?>"/>
                </div>
            </div>
        </div>
		<?php
	...
	function add_new_links() {
        ...
        <div id="mainwp-add-new-links">
            <ul>
                <li>
                    <a class="mainwp-add-new-link"
                       href="<?php echo esc_attr( admin_url( 'admin.php?page=managesites&do=new' ) ); ?>">
                        <i class="fa fa-globe"></i> &nbsp;&nbsp;<?php esc_html_e( 'Site', 'mainwp' ); ?>
                    </a>
                </li>
                <li>
                    <a class="mainwp-add-new-link"
                       href="<?php echo esc_attr( admin_url( 'admin.php?page=PostBulkAdd' ) ); ?>">
                        <i class="fa fa-file-text"></i> &nbsp;&nbsp;<?php esc_html_e( 'Post', 'mainwp' ); ?>
                    </a>
                </li>
                <li>
                    <a class="mainwp-add-new-link"
                       href="<?php echo esc_attr( admin_url( 'admin.php?page=PageBulkAdd' ) ); ?>">
                        <i class="fa fa-file"></i> &nbsp;&nbsp;<?php esc_html_e( 'Page', 'mainwp' ); ?>
                    </a>
                </li>
                <li>
                    <a class="mainwp-add-new-link"
                       href="<?php echo esc_attr( admin_url( 'admin.php?page=PluginsInstall' ) ); ?>">
                        <i class="fa fa-plug"></i> &nbsp;&nbsp;<?php esc_html_e( 'Plugin', 'mainwp' ); ?>
                    </a>
                </li>
                <li>
                    <a class="mainwp-add-new-link"
                       href="<?php echo esc_attr( admin_url( 'admin.php?page=ThemesInstall' ) ); ?>">
                        <i class="fa fa-paint-brush"></i> &nbsp;&nbsp;<?php esc_html_e( 'Theme', 'mainwp' ); ?>
                    </a>
                </li>
                <li>
                    <a class="mainwp-add-new-link"
                       href="<?php echo esc_attr( admin_url( 'admin.php?page=UserBulkAdd' ) ); ?>">
	...
	function update_footer() {
		...
		if ( false ) {
            ...
            <div id="refresh-status-box" title="Syncing Websites" style="display: none; text-align: center">
                ...
                <span id="refresh-status-current">0</span> / <span
                        id="refresh-status-total"><?php echo esc_html( $cntr ); ?></span>
        ...
        <div class="mainwp-popup-overlay-hidden" id="refresh-status-box" tabindex="0" role="dialog"
            ...
            <div class="mainwp-popup-wrap wp-clearfix" role="document">
                <div class="mainwp-popup-header">
                    ...
                    <button type="button" class="close dashicons dashicons-no"><span
