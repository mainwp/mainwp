...
class MainWP_System { // phpcs:ignore Generic.Classes.OpeningBraceSameLine.ContentAfterBrace -- NOSONAR.
     ...
     */
    public static $version = '5.4.0.21'; // NOSONAR.
    ...
    public function admin_enqueue_scripts() {
        ...
        if ( static::is_mainwp_pages() ) {
            ...
            wp_enqueue_script( 'datatables-natural-sorting', MAINWP_PLUGIN_URL . 'assets/js/sorting/natural.js', array( 'jquery', 'datatables' ), $this->current_version, true );
