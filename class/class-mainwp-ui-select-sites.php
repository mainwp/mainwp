 ...
 * @package MainWP\Dashboard
 */
class MainWP_UI_Select_Sites { // phpcs:ignore Generic.Classes.OpeningBraceSameLine.ContentAfterBrace -- NOSONAR.
    ...
    public static function select_sites_box_body( $params = array() ) { // phpcs:ignore -- complex function. Current complexity is the only way to achieve desired results, pull request solutions appreciated.
        ...
        if ( $show_select_all || $show_selectall_disc || $show_new_tag ) :
            ...
            <div id="mainwp-select-sites-select-all-actions" class="ui two columns grid">
                ...
                <div onClick="return mainwp_ss_select( this, true )" role="button" onKeyUp="" class="mainwp-ss-select"><i class="square outline icon"></i> <?php esc_attr_e( 'Select All', 'mainwp' ); ?></div>
                <div onClick="return mainwp_ss_select( this, false )" role="button" onKeyUp="" class="mainwp-ss-deselect" style="display:none;padding-top:0;"><i class="check square outline icon"></i> <?php esc_attr_e( 'Deselect All', 'mainwp' ); ?></div>
                <?php endif; ?>
