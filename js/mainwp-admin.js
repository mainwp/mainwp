...
jQuery(document).ready(function () {
    jQuery('select.mainwp-select2').select2({minimumResultsForSearch: 10, width: '170px', allowClear: true});
    jQuery('select.mainwp-select2-super').select2({minimumResultsForSearch: 10, width: '250px', allowClear: true});
    jQuery('select.mainwp-select2-wpurl-protocol').select2({minimumResultsForSearch: 10, width: '85px', allowClear: true});
    jQuery('#mainwp_managesites_content select#bulk-action-selector-top').select2({minimumResultsForSearch: 10, width: '170px', allowClear: true});
});
