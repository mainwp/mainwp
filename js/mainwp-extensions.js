...
mainwp_extension_bulk_install_done = function() {
    jQuery('.mainwp_extension_installing').append('<div class="mainwp_info-box">' + __("Install finished.") + '</div><p><a href="admin.php?page=Extensions" title="Extensions page">' + __("Return to the Extensions page to Insert API Keys") + '</a></p>');
    setTimeout(function ()
    {
      location.href = 'admin.php?page=Extensions'; 
    }, 2000);
