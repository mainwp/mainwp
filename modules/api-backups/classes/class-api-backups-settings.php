...
class Api_Backups_Settings {
				...
				<div class="ui grid">
					...
					<div class="thirteen wide column">
						...
						<?php if ( isset( $_POST['submit'] ) && isset( $_POST['wp_nonce'] ) && wp_verify_nonce( sanitize_key( $_POST['wp_nonce'] ), 'cloudways_api_form' ) ) : ?>
							...
							<?php Api_Backups_Utility::update_option( 'mainwp_cloudways_api_account_email', $_POST['mainwp_cloudways_api_account_email'] ); ?>
							<?php Api_Backups_Utility::get_instance()->update_api_key( 'cloudways', $_POST['mainwp_cloudways_api_key'] ); ?>
						...
						<?php if ( isset( $_POST['submit'] ) && isset( $_POST['wp_nonce'] ) && wp_verify_nonce( sanitize_key( $_POST['wp_nonce'] ), 'gridpane_api_form' ) ) : ?>
							...
							<?php Api_Backups_Utility::get_instance()->update_api_key( 'gridpane', $_POST['mainwp_gridpane_api_key'] ); ?>
							<div class="ui green message"><i class="close icon"></i><?php esc_html_e( 'API credentials have been successfully saved.', 'mainwp' ); ?></div>
						...
						<?php if ( isset( $_POST['submit'] ) && isset( $_POST['wp_nonce'] ) && wp_verify_nonce( sanitize_key( $_POST['wp_nonce'] ), 'vultr_api_form' ) ) : ?>
							...
							<?php Api_Backups_Utility::get_instance()->update_api_key( 'vultr', $_POST['mainwp_vultr_api_key'] ); ?>
							<div class="ui green message"><i class="close icon"></i><?php esc_html_e( 'API credentials have been successfully saved.', 'mainwp' ); ?></div>
						<?php endif; ?>
						...
						<?php if ( isset( $_POST['submit'] ) && isset( $_POST['wp_nonce'] ) && wp_verify_nonce( sanitize_key( $_POST['wp_nonce'] ), 'linode_api_form' ) ) : ?>
							...
							<?php Api_Backups_Utility::get_instance()->update_api_key( 'linode', $_POST['mainwp_linode_api_key'] ); ?>
							<div class="ui green message"><i class="close icon"></i><?php esc_html_e( 'API credentials have been successfully saved.', 'mainwp' ); ?></div>
						<?php endif; ?>
						...
						<?php if ( isset( $_POST['submit'] ) && isset( $_POST['wp_nonce'] ) && wp_verify_nonce( sanitize_key( $_POST['wp_nonce'] ), 'cpanel_api_form' ) ) : ?>
							...
							<?php Api_Backups_Utility::update_option( 'mainwp_cpanel_url', $_POST['mainwp_cpanel_url'] ); ?>
							<?php Api_Backups_Utility::update_option( 'mainwp_cpanel_site_path', $_POST['mainwp_cpanel_site_path'] ); ?>
							<?php Api_Backups_Utility::update_option( 'mainwp_cpanel_account_username', $_POST['mainwp_cpanel_account_username'] ); ?>
							<?php Api_Backups_Utility::get_instance()->update_api_key( 'cpanel', $_POST['mainwp_cpanel_account_password'] ); ?>
							<div class="ui green message"><i class="close icon"></i><?php esc_html_e( 'API credentials have been successfully saved.', 'mainwp' ); ?></div>
						<?php endif; ?>
						...
						<?php if ( isset( $_POST['submit'] ) && isset( $_POST['wp_nonce'] ) && wp_verify_nonce( sanitize_key( $_POST['wp_nonce'] ), 'plesk_api_form' ) ) : ?>
							...
							<?php Api_Backups_Utility::update_option( 'mainwp_plesk_api_url', $_POST['mainwp_plesk_api_url'] ); ?>
							<?php Api_Backups_Utility::get_instance()->update_api_key( 'plesk', $_POST['mainwp_plesk_api_key'] ); ?>
							<?php
						...
						<div class="ui tab segment active" data-tab="cloudways">
							...
							<div class="ui form">
								<form method="POST" action="">
									...
									<input type="hidden" name="wp_nonce" value="<?php echo wp_create_nonce( 'cloudways_api_form' ); ?>" />
									<?php
									/**
									...
									<div class="ui grid field">
										...
										<div class="five wide column">
											<input type="text" name="mainwp_cloudways_api_account_email" id="mainwp_cloudways_api_account_email" value="<?php echo ( ( false === get_option( 'mainwp_cloudways_api_account_email' ) ) ? '' : get_option( 'mainwp_cloudways_api_account_email' ) ); ?>"  />
										</div>
									</div>
						...
						<div class="ui tab segment" data-tab="gridpane">
							...
							<div class="ui form">
								<form method="POST" action="">
									<?php wp_nonce_field( 'mainwp-admin-nonce' ); ?>
									<input type="hidden" name="wp_nonce" value="<?php echo wp_create_nonce( 'gridpane_api_form' ); ?>" />
									<?php
									/**
						...
						<div class="ui tab segment" data-tab="vultr">
							...
							<div class="ui form">
								<form method="POST" action="">
									<?php wp_nonce_field( 'mainwp-admin-nonce' ); ?>
									<input type="hidden" name="wp_nonce" value="<?php echo wp_create_nonce( 'vultr_api_form' ); ?>" />
									<?php
										/**
						...
						<div class="ui tab segment" data-tab="linode">
							...
							<div class="ui form">
								<form method="POST" action="">
									<?php wp_nonce_field( 'mainwp-admin-nonce' ); ?>
									<input type="hidden" name="wp_nonce" value="<?php echo wp_create_nonce( 'linode_api_form' ); ?>" />
									<?php
										/**
						...
						<div class="ui tab segment" data-tab="digitalocean">
							...
							<div class="ui form">
								<form method="POST" action="">
									<?php wp_nonce_field( 'mainwp-admin-nonce' ); ?>
									<input type="hidden" name="wp_nonce" value="<?php echo wp_create_nonce( 'digitalocean_api_form' ); ?>" />
									<?php
										/**
						...
						<div class="ui tab segment" data-tab="cpanel">
							...
							<div class="ui form">
								<form method="POST" action="">
									<?php wp_nonce_field( 'mainwp-admin-nonce' ); ?>
									<input type="hidden" name="wp_nonce" value="<?php echo wp_create_nonce( 'cpanel_api_form' ); ?>" />
									<?php
									/**
									...
									<div class="ui grid field">
										...
										<div class="five wide column">
											<input type="text" name="mainwp_cpanel_url" id="mainwp_cpanel_url" value="<?php echo ( ( false === get_option( 'mainwp_cpanel_url' ) ) ? '' : get_option( 'mainwp_cpanel_url' ) ); ?>"  />
										</div>
									</div>
									<div class="ui grid field">
										...
										<div class="five wide column">
											<input type="text" name="mainwp_cpanel_account_username" id="mainwp_cpanel_account_username" value="<?php echo ( ( false === get_option( 'mainwp_cpanel_account_username' ) ) ? '' : get_option( 'mainwp_cpanel_account_username' ) ); ?>"  />
										</div>
									</div>
									<div class="ui grid field">
									...
									<div class="ui grid field">
										...
										<div class="five wide column">
											<input type="text" name="mainwp_cpanel_site_path" id="mainwp_cpanel_site_path" value="<?php echo ( ( false === get_option( 'mainwp_cpanel_site_path' ) ) ? '' : get_option( 'mainwp_cpanel_site_path' ) ); ?>"  />
										</div>
									</div>
									<?php
										/**
						...
						<div class="ui tab segment" data-tab="plesk">
							...
							<div class="ui form">
								<form method="POST" action="">
									<?php wp_nonce_field( 'mainwp-admin-nonce' ); ?>
									<input type="hidden" name="wp_nonce" value="<?php echo wp_create_nonce( 'plesk_api_form' ); ?>" />
									<?php
									/**
									...
									<div class="ui grid field">
										...
										<div class="five wide column" data-tooltip="<?php esc_attr_e( 'eg.: https://epic-snyder.123-111-123-143.plesk.page:8443', 'mainwp' ); ?>">
											<input type="text" name="mainwp_plesk_api_url" id="mainwp_plesk_api_url" value="<?php echo ( ( false === get_option( 'mainwp_plesk_api_url' ) ) ? '' : get_option( 'mainwp_plesk_api_url' ) ); ?>"  />
										</div>
									</div>
									<div class="ui grid field">
										<label class="six wide column middle aligned"><?php esc_html_e( 'API Key', 'mainwp' ); ?></label>
	...
	public function hook_mainwp_update_site( $website_id ) {
		...
		$cpanel_api_url = isset( $_POST['cpanel_api_url'] ) ? $_POST['cpanel_api_url'] : '';
		...
		$mainwp_enable_wp_toolkit = isset( $_POST['mainwp_enable_wp_toolkit'] ) ? $_POST['mainwp_enable_wp_toolkit'] : '0';
		Api_Backups_Helper::update_website_option( $website_id, 'mainwp_enable_wp_toolkit', $mainwp_enable_wp_toolkit );

		// Store cPanel Individual or Global toggle.
		$enable_cpanel_individual = isset( $_POST['mainwp_enable_cpanel_individual'] ) ? $_POST['mainwp_enable_cpanel_individual'] : '0';
		...
		$cpanel_account_username = isset( $_POST['mainwp_cpanel_account_username'] ) ? $_POST['mainwp_cpanel_account_username'] : '';
		...
		$cpanel_account_password = isset( $_POST['mainwp_cpanel_account_password'] ) ? $_POST['mainwp_cpanel_account_password'] : '';
		...
		$cpanel_site_path = isset( $_POST['cpanel_site_path'] ) ? $_POST['cpanel_site_path'] : '';
		...
		$enable_plesk_individual = isset( $_POST['mainwp_enable_plesk_individual'] ) ? $_POST['mainwp_enable_plesk_individual'] : '0';
		...
		$plesk_api_url = isset( $_POST['plesk_api_url'] ) ? $_POST['plesk_api_url'] : '';
		...
		$plesk_installation_id = isset( $_POST['plesk_installation_id'] ) ? $_POST['plesk_installation_id'] : '';
				...
				<div class="mainwp_cpanel_individual_container" style="display:none;">
					<div class="ui grid field">
						...
						<div class="ui six wide column" data-tooltip="<?php esc_attr_e( 'Enter the cPanel API URL. eg.: https://yoursite.com:2083', 'mainwp' ); ?>" data-inverted="" data-position="top left">
							<div class="ui left labeled input">
								<input type="text" id="cpanel_api_url" name="cpanel_api_url" value="<?php echo ( empty( $mainwp_cpanel_api_url ) ? '' : $mainwp_cpanel_api_url ); ?>" />
							</div>
						</div>
					</div>
					<div class="ui grid field">
						...
						<div class="ui six wide column" data-tooltip="<?php esc_attr_e( 'Enter the cPanel Account Username.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
							<div class="ui left labeled input">
								<input type="text" name="mainwp_cpanel_account_username" id="mainwp_cpanel_account_username" value="<?php echo ( empty( $mainwp_cpanel_account_username ) ? '' : $mainwp_cpanel_account_username ); ?>"  />
							</div>
						</div>
					</div>
					<div class="ui grid field">
					...
					<div class="ui grid field">
						...
						<div class="ui six wide column" data-tooltip="<?php esc_attr_e( 'Enter the directory the site is installed. eg.: /public_html/child/', 'mainwp' ); ?>" data-inverted="" data-position="top left">
							<div class="ui left labeled input">
								<input type="text" id="cpanel_site_path" name="cpanel_site_path" value="<?php echo ( empty( $mainwp_cpanel_site_path ) ? '' : $mainwp_cpanel_site_path ); ?>" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="mainwp_plesk_individual_container" style="display:none;">
					<div class="ui grid field">
						...
						<div class="ui six wide column" data-tooltip="<?php esc_attr_e( 'eg.: https://epic-snyder.123-111-123-143.plesk.page:8443', 'mainwp' ); ?>" data-inverted="" data-position="top left">
							<div class="ui left labeled input">
								<input type="text" id="plesk_api_url" name="plesk_api_url" value="<?php echo ( empty( $mainwp_plesk_api_url ) ? '' : $mainwp_plesk_api_url ); ?>" />
							</div>
						</div>
					</div>
					<div class="ui grid field">
		...
		<?php elseif ( 'DigitalOcean' === $mainwp_3rd_party_api || 'Linode' === $mainwp_3rd_party_api || 'Vultr' === $mainwp_3rd_party_api ) : ?>
			...
			<div class="ui grid field">
				...
				<div class="ui six wide column" data-tooltip="<?php esc_attr_e( 'Enter the Instance ID (Droplet ID). This information is available in your provider account.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
					<div class="ui left labeled input">
						<input type="text" id="edit_site_module_api_backups_provider_instance_id" name="edit_site_module_api_backups_provider_instance_id" value="<?php echo ( empty( $instance_id ) ? '' : $instance_id ); ?>" />
					</div>
				</div>
			</div>
