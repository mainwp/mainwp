...
return array(
    ...
    1785 => array(
        'type_id'     => 1785,
        'title'       => esc_html__( 'Anyone can register', 'mainwp' ),
    ...
    1790 => array(
        'type_id'     => 1790,
        'title'       => esc_html__( 'New user default role', 'mainwp' ),
    ...
    1795 => array(
        'type_id'     => 1795,
        'title'       => esc_html__( 'Administrator email address', 'mainwp' ),
    ...
    1800 => array(
        'type_id'     => 1800,
        'title'       => esc_html__( 'Permalink structure', 'mainwp' ),
    ...
    1805 => array(
        'type_id'     => 1805,
        'title'       => esc_html__( 'Search engine visibility', 'mainwp' ),
    ...
    1810 => array(
        'type_id'     => 1810,
        'title'       => esc_html__( 'Allow comments', 'mainwp' ),
    ...
    1815 => array(
        'type_id'     => 1815,
        'title'       => esc_html__( 'Comment author name and email', 'mainwp' ),
    ...
    1820 => array(
        'type_id'     => 1820,
        'title'       => esc_html__( 'Comment registration requirement', 'mainwp' ),
    ...
    1825 => array(
        'type_id'     => 1825,
        'title'       => esc_html__( 'Automatically close comments', 'mainwp' ),
    ...
    1830 => array(
        'type_id'     => 1830,
        'title'       => esc_html__( 'Comment closing days', 'mainwp' ),
    ...
    1835 => array(
        'type_id'     => 1835,
        'title'       => esc_html__( 'Comment moderation', 'mainwp' ),
    ...
    1840 => array(
        'type_id'     => 1840,
        'title'       => esc_html__( 'Previously approved comment author', 'mainwp' ),
    ...
    1845 => array(
        'type_id'     => 1845,
        'title'       => esc_html__( 'Comment link limit', 'mainwp' ),
    ...
    1850 => array(
        'type_id'     => 1850,
        'title'       => esc_html__( 'Comment moderation keywords', 'mainwp' ),
    ...
    1855 => array(
        'type_id'     => 1855,
        'title'       => esc_html__( 'Comment blacklist keywords', 'mainwp' ),
    ...
    1860 => array(
        'type_id'     => 1860,
        'title'       => esc_html__( 'WordPress address (URL)', 'mainwp' ),
    ...
    1865 => array(
        'type_id'     => 1865,
        'title'       => esc_html__( 'Site address (URL)', 'mainwp' ),
    ...
    1870 => array(
        'type_id'     => 1870,
        'title'       => esc_html__( 'Homepage display', 'mainwp' ),
    ...
    1875 => array(
        'type_id'     => 1875,
        'title'       => esc_html__( 'Homepage', 'mainwp' ),
    ...
    1880 => array(
        'type_id'     => 1880,
        'title'       => esc_html__( 'Posts page', 'mainwp' ),
    ...
    1885 => array(
        'type_id'     => 1885,
        'title'       => esc_html__( 'Timezone', 'mainwp' ),
    ...
    1890 => array(
        'type_id'     => 1890,
        'title'       => esc_html__( 'Date format', 'mainwp' ),
    ...
    1895 => array(
        'type_id'     => 1895,
        'title'       => esc_html__( 'Time format', 'mainwp' ),
    ...
    1900 => array(
        'type_id'     => 1900,
        'title'       => esc_html__( 'Automatic updates', 'mainwp' ),
    ...
    1905 => array(
        'type_id'     => 1905,
        'title'       => esc_html__( 'Site language', 'mainwp' ),
    ...
    1910 => array(
        'type_id'     => 1910,
        'title'       => esc_html__( 'Site title', 'mainwp' ),
    ...
    1915 => array(
        'type_id'     => 1915,
        'title'       => esc_html__( 'Site icon', 'mainwp' ),
