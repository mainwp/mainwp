 ...
 */
function mainwp_module_log_filter_input( $type, $variable_name, $filter = null, $options = array() ) {
	return call_user_func_array( array( '\MainWP\Dashboard\Module\Log\Log_Filter_Input', 'super' ), func_get_args() );
}
 ...
 */
function mainwp_module_log_filter_var( $var, $filter = null, $options = array() ) {
