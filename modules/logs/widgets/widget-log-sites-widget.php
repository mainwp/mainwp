...
class Log_Sites_Widget {
    ...
    public function render_widget( $args ) {
        ...
        $stats_prev_data = is_array( $data ) && ! empty( $data['stats_prev_data']['site']['sites'] ) ? $data['stats_prev_data']['site']['sites'] : array();
            ...
            <div class="left aligned middle aligned column">
                ...
                <script type="text/javascript">
                    jQuery( document ).ready( function() {
                        ...
                        let clients = new ApexCharts(document.querySelector("#mainwp-module-log-chart-sites-management-wrapper"), options);
                        setTimeout(() => {
                            clients.render();
                        }, 1000);
                    } );
