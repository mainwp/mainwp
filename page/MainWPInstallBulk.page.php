    ...
    <script>
        ...
        createUploader();
         ...
         <div id="MainWPInstallBulkInstallNow" style="display: none">
            ...
            <br />&nbsp;&nbsp;<input type="checkbox" value="2" checked id="chk_overwrite_upload" /> <label for="chk_overwrite_upload"><?php _e('Overwrite existing Plugin, if already installed', 'mainwp'); ?></label><br />
