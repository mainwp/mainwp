    ...
    <div class="wrap"><a href="https://mainwp.com" id="mainwplogo" title="MainWP" target="_blank"><img src="<?php echo plugins_url('images/logo.png', dirname(__FILE__)); ?>" height="50" alt="MainWP" /></a>
        ...
        <?php } ?>
            ...
            <table id="mainwp-security-issues-table">
                ...
                <tr><td><span id="wp_version_loading"><i class="fa fa-spinner fa-lg fa-pulse"></i></span><span id="wp_version_ok" class="mainwp-success-green" style="display: none;"><i class="fa fa-check fa-lg"></i></span><span id="wp_version_nok" class="mainwp-error-red" style="display: none;"><i class="fa fa-times fa-lg"></i></span></td><td><?php _e('Removed wp-version','mainwp'); ?></td><td><span id="wp_version_fix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Fix','mainwp'); ?></a></span><span id="wp_version_unfix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Unfix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="rsd_loading"><i class="fa fa-spinner fa-lg fa-pulse"></i></span><span id="rsd_ok" class="mainwp-success-green" style="display: none;"><i class="fa fa-check fa-lg"></i></span><span id="rsd_nok" class="mainwp-error-red" style="display: none;"><i class="fa fa-times fa-lg"></i></span></td><td><?php _e('Removed Really Simple Discovery meta tag','mainwp'); ?></td><td><span id="rsd_fix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Fix','mainwp'); ?></a></span><span id="rsd_unfix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Unfix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="wlw_loading"><i class="fa fa-spinner fa-lg fa-pulse"></i></span><span id="wlw_ok" class="mainwp-success-green" style="display: none;"><i class="fa fa-check fa-lg"></i></span><span id="wlw_nok" class="mainwp-error-red" style="display: none;"><i class="fa fa-times fa-lg"></i></span></td><td><?php _e('Removed Windows Live Writer meta tag','mainwp'); ?></td><td><span id="wlw_fix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Fix','mainwp'); ?></a></span><span id="wlw_unfix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Unfix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="db_reporting_loading"><i class="fa fa-lg fa-spinner fa-pulse"></i></span><span id="db_reporting_ok" class="mainwp-success-green" style="display: none;"><i class="fa fa-check fa-lg"></i></span><span id="db_reporting_nok" class="mainwp-error-red" style="display: none;"><i class="fa fa-times fa-lg"></i></span></td><td><?php _e('Database error reporting turned off','mainwp'); ?></td><td><span id="db_reporting_fix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Fix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="php_reporting_loading"><i class="fa fa-lg fa-spinner fa-pulse"></i></span><span id="php_reporting_ok" class="mainwp-success-green" style="display: none;"><i class="fa fa-check fa-lg"></i></span><span id="php_reporting_nok" class="mainwp-error-red" style="display: none;"><i class="fa fa-times fa-lg"></i></span></td><td><?php _e('PHP error reporting turned off','mainwp'); ?></td><td><span id="php_reporting_fix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Fix','mainwp'); ?></a></span><span id="php_reporting_unfix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Unfix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="versions_loading"><i class="fa fa-spinner fa-lg fa-pulse"></i></span><span id="versions_ok" class="mainwp-success-green" style="display: none;"><i class="fa fa-check fa-lg"></i></span><span id="versions_nok" class="mainwp-error-red" style="display: none;"><i class="fa fa-times fa-lg"></i></span></td><td><?php _e('Removed version information for scripts/stylesheets','mainwp'); ?></td><td><span id="versions_fix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Fix','mainwp'); ?></a></span><span id="versions_unfix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Unfix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="readme_loading"><i class="fa fa-spinner fa-lg fa-pulse"></i></span><span id="readme_ok" class="mainwp-success-green" style="display: none;"><i class="fa fa-check fa-lg"></i></span><span id="readme_nok" class="mainwp-error-red" style="display: none;"><i class="fa fa-times fa-lg"></i></span></td><td><?php _e('readme.html removed','mainwp'); ?></td><td><span id="readme_fix" style="display: none"><a href="#" style="text-decoration: none;"><i class="fa fa-wrench"></i> <?php _e('Fix','mainwp'); ?></a></span><span id="readme_unfix" style="display: none"><font color="gray"><i class="fa fa-wrench"></i> <?php _e('Unfix','mainwp'); ?></font> - <?php _e('You need to re-upload the readme.html file manually to unfix this.','mainwp'); ?></span></td></tr>
                <tr><td><span id="admin_loading"><i class="fa fa-spinner fa-lg fa-pulse"></i></span><span id="admin_ok" class="mainwp-success-green" style="display: none;"><i class="fa fa-check fa-lg"></i></span><span id="admin_nok" class="mainwp-error-red" style="display: none;"><i class="fa fa-times fa-lg"></i></span></td><td><?php _e('Administrator username should not be Admin','mainwp'); ?></td><td><span id="admin_fix" style="display: none"></span><ol><li><?php _e('If this user was used as your MainWP Secure Link Admin, you will need to change your Administrator Username in the MainWP Dashboard for the site.','mainwp'); ?> - <a href="http://docs.mainwp.com/deleting-secure-link-admin/" style="text-decoration: none;" ><?php _e('Documentation','mainwp'); ?></a></li><li><?php _e('You have to change this yourself','mainwp'); ?> - <a href="http://blog.mainwp.com/change-default-wordpress-admin-username/" target="_blank" style="text-decoration: none;"><?php _e('Tutorial','mainwp'); ?></a></li></ol></td></tr>
            </table>
            <br /><input type="button" id="securityIssues_fixAll" class="button-primary button button-hero" value="<?php _e('Fix All','mainwp'); ?>"/> <input type="button" id="securityIssues_refresh" class="button button-hero" value="<?php _e('Refresh','mainwp'); ?>"/>
            </div>
            </div>
   <?php if ($with_header) { ?>
        </div>
