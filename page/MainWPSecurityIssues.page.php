    ...
    <div class="wrap"><a href="https://mainwp.com" id="mainwplogo" title="MainWP" target="_blank"><img src="<?php echo plugins_url('images/logo.png', dirname(__FILE__)); ?>" height="50" alt="MainWP" /></a>
        ...
        <?php } ?>
            ...
            <table id="mainwp-security-issues-table">
                <tr><td><span id="listing_loading"><i class="fa fa-spinner fa-pulse"></i></span><span id="listing_ok" style="display: none;"><img src="<?php echo plugins_url('images/ok.png', dirname(__FILE__)); ?>"/></span><span id="listing_nok"  style="display: none;"><img src="<?php echo plugins_url('images/nok.png', dirname(__FILE__)); ?>"/></span></td><td><?php _e('Prevent listing wp-content, wp-content/plugins, wp-content/themes, wp-content/uploads','mainwp'); ?></td><td><span id="listing_fix" style="display: none"><a href="#"><?php _e('Fix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="wp_version_loading"><i class="fa fa-spinner fa-pulse"></i></span><span id="wp_version_ok" style="display: none;"><img src="<?php echo plugins_url('images/ok.png', dirname(__FILE__)); ?>"/></span><span id="wp_version_nok"  style="display: none;"><img src="<?php echo plugins_url('images/nok.png', dirname(__FILE__)); ?>"/></span></td><td><?php _e('Removed wp-version','mainwp'); ?></td><td><span id="wp_version_fix" style="display: none"><a href="#"><?php _e('Fix','mainwp'); ?></a></span><span id="wp_version_unfix" style="display: none"><a href="#"><?php _e('Unfix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="rsd_loading"><i class="fa fa-spinner fa-pulse"></i></span><span id="rsd_ok" style="display: none;"><img src="<?php echo plugins_url('images/ok.png', dirname(__FILE__)); ?>"/></span><span id="rsd_nok"  style="display: none;"><img src="<?php echo plugins_url('images/nok.png', dirname(__FILE__)); ?>"/></span></td><td><?php _e('Removed Really Simple Discovery meta tag','mainwp'); ?></td><td><span id="rsd_fix" style="display: none"><a href="#"><?php _e('Fix','mainwp'); ?></a></span><span id="rsd_unfix" style="display: none"><a href="#"><?php _e('Unfix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="wlw_loading"><i class="fa fa-spinner fa-pulse"></i></span><span id="wlw_ok" style="display: none;"><img src="<?php echo plugins_url('images/ok.png', dirname(__FILE__)); ?>"/></span><span id="wlw_nok"  style="display: none;"><img src="<?php echo plugins_url('images/nok.png', dirname(__FILE__)); ?>"/></span></td><td><?php _e('Removed Windows Live Writer meta tag','mainwp'); ?></td><td><span id="wlw_fix" style="display: none"><a href="#"><?php _e('Fix','mainwp'); ?></a></span><span id="wlw_unfix" style="display: none"><a href="#"><?php _e('Unfix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="db_reporting_loading"><i class="fa fa-spinner fa-pulse"></i></span><span id="db_reporting_ok" style="display: none;"><img src="<?php echo plugins_url('images/ok.png', dirname(__FILE__)); ?>"/></span><span id="db_reporting_nok"  style="display: none;"><img src="<?php echo plugins_url('images/nok.png', dirname(__FILE__)); ?>"/></span></td><td><?php _e('Database error reporting turned off','mainwp'); ?></td><td><span id="db_reporting_fix" style="display: none"><a href="#"><?php _e('Fix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="php_reporting_loading"><i class="fa fa-spinner fa-pulse"></i></span><span id="php_reporting_ok" style="display: none;"><img src="<?php echo plugins_url('images/ok.png', dirname(__FILE__)); ?>"/></span><span id="php_reporting_nok"  style="display: none;"><img src="<?php echo plugins_url('images/nok.png', dirname(__FILE__)); ?>"/></span></td><td><?php _e('PHP error reporting turned off','mainwp'); ?></td><td><span id="php_reporting_fix" style="display: none"><a href="#"><?php _e('Fix','mainwp'); ?></a></span><span id="php_reporting_unfix" style="display: none"><a href="#">Unfix</a></span></td></tr>
                <tr><td><span id="versions_loading"><i class="fa fa-spinner fa-pulse"></i></span><span id="versions_ok" style="display: none;"><img src="<?php echo plugins_url('images/ok.png', dirname(__FILE__)); ?>"/></span><span id="versions_nok"  style="display: none;"><img src="<?php echo plugins_url('images/nok.png', dirname(__FILE__)); ?>"/></span></td><td><?php _e('Removed version information for scripts/stylesheets','mainwp'); ?></td><td><span id="versions_fix" style="display: none"><a href="#"><?php _e('Fix','mainwp'); ?></a></span><span id="versions_unfix" style="display: none"><a href="#"><?php _e('Unfix','mainwp'); ?></a></span></td></tr>
                <tr><td><span id="readme_loading"><i class="fa fa-spinner fa-pulse"></i></span><span id="readme_ok" style="display: none;"><img src="<?php echo plugins_url('images/ok.png', dirname(__FILE__)); ?>"/></span><span id="readme_nok"  style="display: none;"><img src="<?php echo plugins_url('images/nok.png', dirname(__FILE__)); ?>"/></span></td><td><?php _e('readme.html removed','mainwp'); ?></td><td><span id="readme_fix" style="display: none"><a href="#"><?php _e('Fix','mainwp'); ?></a></span><span id="readme_unfix" style="display: none"><font color="gray"><?php _e('Unfix','mainwp'); ?></font> - <?php _e('You need to re-upload the readme.html file manually to unfix this.','mainwp'); ?></span></td></tr>
                <tr><td><span id="admin_loading"><i class="fa fa-spinner fa-pulse"></i></span><span id="admin_ok" style="display: none;"><img src="<?php echo plugins_url('images/ok.png', dirname(__FILE__)); ?>"/></span><span id="admin_nok"  style="display: none;"><img src="<?php echo plugins_url('images/nok.png', dirname(__FILE__)); ?>"/></span></td><td><?php _e('Administrator username should not be Admin','mainwp'); ?></td><td><span id="admin_fix" style="display: none"></span><ol><li><?php _e('If this user was used as your MainWP Secure Link Admin, you will need to change your Administrator Username in the MainWP Dashboard for the site.','mainwp'); ?> - <a href="http://docs.mainwp.com/deleting-secure-link-admin/" ><?php _e('Documentation','mainwp'); ?></a></li><li><?php _e('You have to change this yourself','mainwp'); ?> - <a href="http://blog.mainwp.com/change-default-wordpress-admin-username/" target="_blank"><?php _e('Tutorial','mainwp'); ?></a></li></ol></td></tr>
            </table>
