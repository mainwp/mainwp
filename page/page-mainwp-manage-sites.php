	...
	public static function checkSite() {
		...
		if ( MainWP_Utility::can_edit_website( $website ) ) { //Already added to the database - so exists.
			...
			try {
				...
				$information = MainWP_Utility::fetchUrlNotAuthed( $_POST['url'], $_POST['admin'], 'stats', null, false, null, $http_user, $http_pass ); //Fetch the stats with the given admin name
