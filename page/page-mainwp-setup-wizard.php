...
class MainWP_Setup_Wizard {
	...
	public function mwp_setup_windows_locahost() {
		...
		$openssl_loc = get_option('mwp_setup_opensslLibLocation', 'c:\xampplite\apache\conf\openssl.conf');
		?>
		...
		<form method="post" class="form-table">
			...
			<em><?php echo sprintf( __( 'In most cases %s should be your path if using a normal install.%sIf not your will need to change that to match your specific path.', 'mainwp' ), 'c:\\xampplite\\apache\\conf\\openssl.conf', '<br />' ); ?></em>
			<br /><br />
			<p class="mwp-setup-actions step">
				<input type="submit" class="button-primary button button-large" value="<?php esc_attr_e( 'Continue', 'mainwp' ); ?>" name="save_step" />
