 ...
 * @package MainWP\Dashboard
 */
class MainWP_Manage_Groups { // phpcs:ignore Generic.Classes.OpeningBraceSameLine.ContentAfterBrace -- NOSONAR.
    ...
    public static function get_website_list_content() {
        ...
        while ( $websites && ( $website = MainWP_DB::fetch_object( $websites ) ) ) {
            ...
            <tr id="<?php echo esc_attr( $website->id ); ?>">
                <td class="check-column collapsing">
                ...
                <td class="not-selectable center aligned">
                    ...
                    <span class="mainwp-preview-item ui mini grey icon basic button" data-position="left center" data-inverted="" data-tooltip="<?php esc_attr_e( 'Click to see the site homepage screenshot . ', 'mainwp' ); ?>" preview-site-url="<?php echo esc_url( $website->url ); ?>" data-mainwp-mshot-src="<?php echo esc_attr( $site_mshot['src'] ); ?>" data-mainwp-mshot-requeue-src="<?php echo esc_attr( $site_mshot['requeue_src'] ); ?>" ><i class="camera icon"></i></span>
                </td>
                <td class="not-selectable center aligned">
