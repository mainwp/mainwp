...
class MainWP_Server_Information { // phpcs:ignore Generic.Classes.OpeningBraceSameLine.ContentAfterBrace -- NOSONAR.
    ...
    public static function render() {
        ...
        <table id="mainwp-system-report-wordpress-table" class="ui unstackable table single line mainwp-system-report-table mainwp-system-info-table">
                <thead>
                    <tr>
                        <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'WordPress Check' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'WordPress Check', 'mainwp' ); ?></th>
                        <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'Required' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Required', 'mainwp' ); ?></th>
                        <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'Detected' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Detected', 'mainwp' ); ?></th>
        ...
        <table id="mainwp-system-report-php-table" class="ui unstackable table fixed mainwp-system-report-table mainwp-system-info-table">
            <thead>
                <tr>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'PHP' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'PHP', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'Required' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Required', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'Detected' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Detected', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide right aligned"></th>
                </tr>
        ...
        <table id="mainwp-system-report-mysql-table" class="ui unstackable table mainwp-system-report-table mainwp-system-info-table">
            <thead>
                <tr>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'MySQL' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'MySQL', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'Required' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Required', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'Detected' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Detected', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide right aligned"></th>
                </tr>
        ...
        <?php static::render_report_section_table( 'mainwp-system-report-connectivity-table', esc_html__( 'Connectivity & Authentication', 'mainwp' ), MainWP_Server_Information_Handler::get_connectivity_report_rows(), 'Connectivity & Authentication' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-scheduler-table', esc_html__( 'Scheduler & Background Jobs', 'mainwp' ), MainWP_Server_Information_Handler::get_scheduler_report_rows(), 'Scheduler & Background Jobs' ); ?>
        ...
        <table id="mainwp-system-report-server-table" class="ui unstackable table mainwp-system-report-table mainwp-system-info-table">
            <thead>
                <tr>
                    <th scope="col" class="seven wide"<?php echo static::get_export_text_attr( 'Server Configuration' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Server Configuration', 'mainwp' ); ?></th>
                    <th scope="col" class="nine wide"<?php echo static::get_export_text_attr( 'Detected Value' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Detected Value', 'mainwp' ); ?></th>
                </tr>
            </thead>
            <tbody>
        ...
        <?php static::render_report_section_table( 'mainwp-system-report-overview-table', esc_html__( 'MainWP Overview', 'mainwp' ), MainWP_Server_Information_Handler::get_mainwp_overview_report_rows(), 'MainWP Overview' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-general-settings-table', esc_html__( 'MainWP General Settings', 'mainwp' ), MainWP_Server_Information_Handler::get_general_settings_report_rows(), 'MainWP General Settings' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-advanced-settings-table', esc_html__( 'MainWP Advanced Settings', 'mainwp' ), MainWP_Server_Information_Handler::get_advanced_settings_report_rows(), 'MainWP Advanced Settings' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-monitoring-settings-table', esc_html__( 'MainWP Monitoring Settings', 'mainwp' ), MainWP_Server_Information_Handler::get_monitoring_settings_report_rows(), 'MainWP Monitoring Settings' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-email-settings-table', esc_html__( 'MainWP Email Settings', 'mainwp' ), MainWP_Server_Information_Handler::get_email_settings_report_rows(), 'MainWP Email Settings' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-cost-tracker-settings-table', esc_html__( 'MainWP Cost Tracker Settings', 'mainwp' ), MainWP_Server_Information_Handler::get_cost_tracker_report_rows(), 'MainWP Cost Tracker Settings' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-network-activity-settings-table', esc_html__( 'MainWP Network Activity Settings', 'mainwp' ), MainWP_Server_Information_Handler::get_insights_report_rows(), 'MainWP Network Activity Settings' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-api-backups-settings-table', esc_html__( 'MainWP API Backups Settings', 'mainwp' ), MainWP_Server_Information_Handler::get_api_backups_report_rows(), 'MainWP API Backups Settings' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-tools-settings-table', esc_html__( 'MainWP Tools Settings', 'mainwp' ), MainWP_Server_Information_Handler::get_tools_report_rows(), 'MainWP Tools Settings' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-debug-settings-table', esc_html__( 'Debug & Logs', 'mainwp' ), MainWP_Server_Information_Handler::get_debug_report_rows(), 'Debug & Logs' ); ?>

        <?php static::render_report_section_table( 'mainwp-system-report-conflict-signals-table', esc_html__( 'Potential Conflicts', 'mainwp' ), MainWP_Server_Information_Handler::get_conflict_signal_report_rows(), 'Potential Conflicts' ); ?>
        ...
        <table id="mainwp-system-report-extensions-table" class="ui unstackable table single line mainwp-system-report-table mainwp-system-info-table">
            <thead>
                <tr>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'Extensions' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Extensions', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'Version' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Version', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'License' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'License', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide right aligned"></th>
                </tr>
            </thead>
            <tbody>
        ...
        <table id="mainwp-system-report-plugins-table" class="ui single line table unstackable mainwp-system-report-table mainwp-system-info-table">
            <thead>
                <tr>
                    <th scope="col" class="eight wide"<?php echo static::get_export_text_attr( 'Plugin' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Plugin', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide"<?php echo static::get_export_text_attr( 'Version' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Version', 'mainwp' ); ?></th>
                    <th scope="col" class="four wide right aligned"></th>
                </tr>
            </thead>
    ...
    public static function render_wordpress_check_tbody() {
        ...
        ?>
        <tr>
            <td<?php echo static::get_export_text_attr( 'FileSystem Method' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'FileSystem Method', 'mainwp' ); ?></td>
    ...
    public static function render_php_check_tbody() {
        ...
        ?>
        <tr>
            <td<?php echo static::get_export_text_attr( 'PHP Allow URL fopen' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'PHP Allow URL fopen', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_php_allow_url_fopen(); ?></td>
            <td></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'PHP Exif Support' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'PHP Exif Support', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_php_exif(); ?></td>
            <td></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'PHP IPTC Support' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'PHP IPTC Support', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_php_iptc(); ?></td>
            <td></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'PHP XML Support' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'PHP XML Support', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_php_xml(); ?></td>
            <td></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Function `tmpfile` enabled' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Function `tmpfile` enabled', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
            <td>
            <?php
        ...
        <tr>
            <td<?php echo static::get_export_text_attr( 'PHP Session enabled' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'PHP Session enabled', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
            <td>
            <?php
        ...
        <tr>
            <td<?php echo static::get_export_text_attr( 'PHP Disabled Functions' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'PHP Disabled Functions', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
            <td><?php static::php_disabled_functions(); ?></td>
            <td></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'PHP Loaded Extensions' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'PHP Loaded Extensions', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
    ...
    public static function render_mysql_check_tbody() {
        ...
        ?>
                    <tr>
            <td<?php echo static::get_export_text_attr( 'MySQL Mode' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'MySQL Mode', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_sql_mode(); ?></td>
            <td></td>
                    </tr>
                    <tr>
            <td<?php echo static::get_export_text_attr( 'MySQL Client Encoding' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'MySQL Client Encoding', 'mainwp' ); ?></td>
            <td><?php esc_html_e( 'N/A', 'mainwp' ); ?></td>
    ...
    public static function render_server_check_tbody() {
        ...
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'WordPress Root Directory' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'WordPress Root Directory', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_wp_root(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'Server Name' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Server Name', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_server_name(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Server Software' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Server Software', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_server_software(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Operating System' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Operating System', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_os(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Architecture' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Architecture', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_architecture(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'Server IP' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Server IP', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_server_ip(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Server Protocol' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Server Protocol', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_server_protocol(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'HTTP Host' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'HTTP Host', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_http_host(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'User Agent' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'User Agent', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_user_agent(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'Server Port' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Server Port', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_server_port(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Gateway Interface' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Gateway Interface', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_server_gateway_interface(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Memory Usage' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Memory Usage', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::memory_usage(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'Referrer URL' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Referrer URL', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_complete_url(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Request Time' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Request Time', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_server_request_time(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Accept Content' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Accept Content', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_server_http_accept(); ?></td>
        </tr>
        <tr>
            <td<?php echo static::get_export_text_attr( 'Accept-Charset Content' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Accept-Charset Content', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_server_accept_charset(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'Currently Executing Script Pathname' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Currently Executing Script Pathname', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_script_file_name(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'Current Page URI' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Current Page URI', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_current_page_uri(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'Remote Address' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Remote Address', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_remote_address(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'Remote Host' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Remote Host', 'mainwp' ); ?></td>
            <td><?php MainWP_Server_Information_Handler::get_remote_host(); ?></td>
        </tr>
        <tr class="mwp-not-generate-row">
            <td<?php echo static::get_export_text_attr( 'Remote Port' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Remote Port', 'mainwp' ); ?></td>
    ...
    public static function render_action_logs() { // phpcs:ignore -- NOSONAR -Current complexity is the only way to achieve desired results, pull request solutions appreciated.
        ...
        $specific_default = array(
            ...
            MainWP_Logger::EXECUTION_SYNC_DETAILS_LOG_PRIORITY => esc_html__( 'Execution Sync Details', 'mainwp' ),
    ...
    private static function render_report_section_table( $table_id, $title, $rows, $export_title = '' ) {
        ...
        <table id="<?php echo esc_attr( $table_id ); ?>" class="ui unstackable table mainwp-system-report-table mainwp-system-info-table">
            <thead>
                <tr>
                    <th scope="col" class="seven wide"<?php echo static::get_export_text_attr( $export_title ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php echo esc_html( $title ); ?></th>
                    <th scope="col" class="seven wide"<?php echo static::get_export_text_attr( 'Detected Value' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php esc_html_e( 'Detected Value', 'mainwp' ); ?></th>
    ...
    private static function render_report_row( $row ) {
        ...
        <tr class="<?php echo esc_attr( implode( ' ', $row_classes ) ); ?>">
            <td<?php echo static::get_export_text_attr( $export_label ); // phpcs:ignore WordPress.Security.EscapeOutput ?>><?php echo esc_html( isset( $row['label'] ) ? $row['label'] : '' ); ?></td>
