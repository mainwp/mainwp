...
class MainWP_Setup_Wizard {
	...
	public function mwp_setup_welcome() {
		...
		<div class="ui hidden divider"></div>
		<h3><?php esc_html_e( 'Would you like to see Demo content first? ', 'mainwp' ); ?> - <?php echo sprintf( esc_html__( '%1$sWhat is this?%2$s', 'mainwp' ), '<a href="https://www.youtube.com/watch?v=fCHT47AKt7s" target="_blank">', '</a>' ); ?></h3>
