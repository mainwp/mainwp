...
class MainWP_User {
	...
	public static function init() {
		...
		add_action( 'mainwp_help_sidebar_content', array( MainWP_User::getClassName(), 'mainwp_help_content' ) ); // Hook the Help Sidebar content
	}
	...
	public static function initMenu() {
        ...
        MainWP_User::init_left_menu(self::$subPages);
	}
    ...
    <div id="mainwp-manage-users" class="ui alt segment">
        ...
        <div class="mainwp-actions-bar ui mini form">
	      ...
	      <div id="mainwp-update-users-box" class="ui segment">
	        <?php MainWP_User::renderUpdateUsers(); ?>
	      </div>
			</div>
    ...
    <div class="ui mini form">
			<div class="field">
				<div class="ui input fluid">
					<input type="text" placeholder="<?php esc_attr_e( 'Username', 'mainwp' ); ?>" id="mainwp_search_users" class="text" value="<?php if ( $cachedSearch != null ) { echo esc_attr($cachedSearch[ 'keyword' ]); } ?>"/>
				</div>
			</div>
		</div>
	  <?php
