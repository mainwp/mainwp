                    ...
                    <td style="vertical-align:top;text-align:center;">
                        <table style="border:0;padding:0;border-spacing:0;width:600px;background-color:#ffffff;border:1px solid #dedede;box-shadow: 0 1px 4px rgba(0,0,0,0.1);border-radius:3px;padding-bottom:30px;">
                            ...
                            <tr>
                                ...
                                <p><?php esc_html_e( 'This email was generated by your MainWP Dashboard, not sent directly by MainWP, the company.', 'mainwp' ); ?></p>
                                <p><?php esc_html_e( 'Need more info?', 'mainwp' ); ?> <a href="https://mainwp.com/kb/manage-child-sites/#uptime-monitoring"><?php esc_html_e( 'See this Knowledgebase article', 'mainwp' ); ?></a>.</p>
