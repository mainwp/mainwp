	...
	public static function renderHeader( $shownPage, &$extensions ) {
		...
		<?php if ( $shownPage === '' ) { ?>
			<div id="mainwp-extensions-categories-menu" class="postbox">
				<div class="mainwp-inside">
					<span id="mainwp-extensions-menu-title"><?php _e( 'Get MainWP Extensions', 'mainwp' ); ?></span>
				</div>
				...
				<div class="mainwp-inside mainwp-align-center" style="clear: both;">
					<div id="mainwp-extensions-cat-menu">
						<ul id="mainwp-extensions-menu-cat-list">
							<li class="mainwp-extensions-menu-item mainwp-category-1">
								<a href="https://extensions.mainwp.com/product-category/mainwp-extensions/administrative/"><?php _e( 'Administrative', 'mainwp' ); ?></a>
							</li>
							<li class="mainwp-extensions-menu-item mainwp-category-2">
								<a href="https://extensions.mainwp.com/product-category/mainwp-extensions/content/"><?php _e( 'Content', 'mainwp' ); ?></a>
							</li>
							<li class="mainwp-extensions-menu-item mainwp-category-3">
								<a href="https://extensions.mainwp.com/product-category/mainwp-extensions/visitor-data/"><?php _e( 'Visitor Data', 'mainwp' ); ?></a>
							</li>
							<li class="mainwp-extensions-menu-item mainwp-category-4">
								<a href="https://extensions.mainwp.com/product-category/mainwp-extensions/free/"><?php _e( 'Free Extensions', 'mainwp' ); ?></a>
							</li>
							<li class="mainwp-extensions-menu-item mainwp-category-5">
								<a href="https://extensions.mainwp.com/shop/"><?php _e( 'All Extensions', 'mainwp' ); ?></a>
							</li>
						</ul>
					</div>
			...
			if ( mainwp_current_user_can( 'dashboard', 'bulk_install_and_activate_extensions' ) ) {
				...
				<div class="postbox mainwp_api_postbox" section="1">
					...
					<div class="mainwp-inside" style="clear: both;">
						<div style="padding: 0 5px;">
							...
							<p>
								<span class="description"><?php _e( 'Enter your MainWP Extensions (https://extensions.mainwp.com) Login to automatically install and activate purchased extensions.' ); ?></span>
							</p>
							...
							<div class="api-grabbing-fields">
								...
								<label><input type="checkbox" <?php echo $checked_save ? 'checked="checked"' : ''; ?> name="extensions_api_savemylogin_chk" id="extensions_api_savemylogin_chk"><?php _e( 'Save API login', 'mainwp' ); ?>
								</label>
							</div>
							<p>
				<span class="extension_api_loading">
					...
					<i class="fa fa-spinner fa-pulse" style="display: none;"></i><span class="status hidden"></span>
							...
							<div id="mainwp-install-purchased-extensions">
								<p>
									<span class="description"><?php _e( 'The Install Purchased Extensions button will automatically install all your MainWP Extensions. You can also install them manually using the directions <a href="http://docs.mainwp.com/how-to-install-mainwp-extensions/" >here</a>.' ); ?></span>
								</p>
				...
				<span class="extension_api_loading">
					...
					<i class="fa fa-spinner fa-pulse" style="display: none;"></i><span class="status hidden"></span>
							...
							<p>
								<span class="description"><?php _e( 'The Grab API Keys will automatically add your API Keys and activate your Extensions. You can also manually enter your API for each Extension following the steps <a href="http://docs.mainwp.com/enter-extensions-api-keys/" >here</a>.' ); ?></span>
							</p>
			...
			<?php if ( count( $extensions ) == 0 ) { ?>
				<div class="inside">
					<div class="mainwp_info-box-blue">
						...
						<p>
							<a href="https://extensions.mainwp.com/"><?php _e( 'Download your first extension now.', 'mainwp' ); ?></a>
						</p>
					</div>
				</div>
			<?php } else {
								...
								<table style="width: 100%">
									<td class="mainwp-extensions-childIcon">
										...
										if ( isset( $extension['iconURI'] ) && ( $extension['iconURI'] != '' ) ) {
											?>
											<img title="<?php echo $extension['name']; ?>" src="<?php echo MainWP_Utility::removeHttpPrefix( $extension['iconURI'] ); ?>" class="mainwp-extensions-img large <?php echo( $active ? '' : 'mainwp-extension-icon-desaturated' ); ?>" /><?php
										} else {
											?>
													...
													<?php } else {
														...
														if ( isset( $extension['mainwp'] ) && ($extension['mainwp'] == true) ) {
															...
															if ( isset( $extension['api'] ) ) {
																...
																$locked = (MainWP_API_Settings::testAPIs( $extension['api'] ) != 'VALID');
															}
														} else {
					...
					foreach ( $all_extensions as $ext ) {
						...
						<div class="mainwp-availbale-extension-holder <?php echo ( $is_free ) ? 'mainwp-free' : 'mainwp-paid'; ?>" style="clear: both;">
							...
							<div class="mainwp-av-ext-buttons">
								...
								?>
								<a href="<?php echo str_replace( array(
									'http:',
									'https:'
								), '', $ext['link'] ); ?>" class="button">Find Out More</a>
								<a href="<?php echo str_replace( array(
									'http:',
									'https:'
								), '', $ext['link'] ); ?>" class="button button-primary mainwp-upgrade-button">Order Now</a>
							</div>
