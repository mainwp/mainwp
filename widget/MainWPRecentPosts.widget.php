        ...
        <div class="clear">
            ...
            <div class="recent_posts_published">
                ...
                <div class="mainwp-row mainwp-recent">
                    ...
                    <span class="mainwp-right-col"><a href="<?php echo $recent_posts_published[$i]['website']->url; ?>" target="_blank"><i class="fa fa-external-link"></i> <?php echo MainWPUtility::getNiceURL($recent_posts_published[$i]['website']->url); ?></a> <br/><?php echo $recent_posts_published[$i]['dts']; ?></span>
