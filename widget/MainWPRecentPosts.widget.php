        ...
        <div class="clear">
            ...
            <div class="recent_posts_published">
                ...
                <div class="mainwp-row mainwp-recent">
                    ...
                    <span class="mainwp-left-col"><a href="<?php echo $recent_posts_published[$i]['website']->url; ?>?p=<?php echo $recent_posts_published[$i]['id']; ?>" target="_blank"><?php echo htmlentities($recent_posts_published[$i]['title']); ?></a></span>
            ...
            <div class="recent_posts_draft" style="display: none">
                ...
                <div class="mainwp-row mainwp-recent">
                    ...
                    <span class="mainwp-left-col"><a href="<?php echo $recent_posts_draft[$i]['website']->url; ?>?p=<?php echo $recent_posts_draft[$i]['id']; ?>" target="_blank"><?php echo htmlentities($recent_posts_draft[$i]['title']); ?></a></span>
                    <span class="mainwp-mid-col">
            ...
            <div class="recent_posts_pending" style="display: none">
                ...
                <div class="mainwp-row mainwp-recent">
                    ...
                    <span class="mainwp-left-col"><a href="<?php echo $recent_posts_pending[$i]['website']->url; ?>?p=<?php echo $recent_posts_pending[$i]['id']; ?>" target="_blank"><?php echo htmlentities($recent_posts_pending[$i]['title']); ?></a></span>
                    <span class="mainwp-mid-col">
            ...
            <div class="recent_posts_trash" style="display: none">
                ...
                <div class="mainwp-row mainwp-recent">
                    ...
                    <span class="mainwp-left-col"><?php echo htmlentities($recent_posts_trash[$i]['title']); ?></span>
                    <span class="mainwp-mid-col">
