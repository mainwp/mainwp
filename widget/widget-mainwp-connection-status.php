                                ...
                                <div class="<?php echo $is_top_row ? 'mainwp-row-top' : 'mainwp-row' ?> mainwp_wp_sync" site_id="<?php echo $website->id; ?>" site_name="<?php echo rawurlencode( $website->name ); ?>">
                                            <div class="mainwp-left mainwp-cols-3 mainwp-padding-top-10">
                                                    ...
                                                    <div class="mainwp-row-actions">
                                                        <span class="edit"><a href="<?php echo $website->url; ?>"  class="mainwp-may-hide-referrer" target="_blank" title="<?php _e( 'Visit Site', 'mainwp' ); ?>"><?php _e( 'Visit Site', 'mainwp' ); ?></a> | </span>
                                            ...
                                            <div class="mainwp-right mainwp-cols-4 mainwp-t-align-right mainwp-padding-top-5 wordpressAction">
                                                ...
                                                if ( $md5Connection ) {
                                                    ?>
                                                    <div style="position: absolute; padding-top: 5px; padding-right: 10px; right: 50px;"><?php _e('MD5 Connection'); ?><br /><a href="http://mainwp.com/help/docs/md5-connection-issue/" target="_blank"><?php _e('Read More'); ?></a></div>
