			...
			<div class="recent_posts_published">
				...
				for ( $i = 0; $i < count( $recent_pages_published ) && $i < 5; $i ++ ) {
					...
					<div class="mainwp-row mainwp-recent">
						...
						<span class="mainwp-left mainwp-cols-2"><a href="<?php echo esc_url($recent_pages_published[ $i ]['website']->url); ?>?p=<?php echo esc_attr($recent_pages_published[ $i ]['id']); ?>" target="_blank" class="mainwp-may-hide-referrer"><?php echo htmlentities( $recent_pages_published[ $i ]['title'], ENT_COMPAT | ENT_HTML401, 'UTF-8' ); ?></a></span>
						...
						<span class="mainwp-right mainwp-cols-3">
							<a href="<?php echo esc_url($recent_pages_published[ $i ]['website']->url); ?>" class="mainwp-may-hide-referrer" target="_blank">
						...
						<div class="mainwp-row-actions">
							...
							<a href="<?php echo esc_url($recent_pages_published[ $i ]['website']->url) . ( substr( $recent_pages_published[ $i ]['website']->url, - 1 ) != '/' ? '/' : '' ) . '?p=' . $recent_pages_published[ $i ]['id']; ?>" target="_blank" class="mainwp-may-hide-referrer" title="View '<?php echo esc_html( $recent_pages_published[ $i ]['title'] ); ?>'" rel="permalink"><?php _e( 'View', 'mainwp' ); ?></a> |
			...
			<div class="recent_posts_draft" style="display: none">
				...
				for ( $i = 0; $i < count( $recent_pages_draft ) && $i < 5; $i ++ ) {
					...
					<div class="mainwp-row mainwp-recent">
						...
						<span class="mainwp-left mainwp-cols-2"><a href="<?php echo esc_url($recent_pages_draft[ $i ]['website']->url); ?>?p=<?php echo esc_attr($recent_pages_draft[ $i ]['id']); ?>" class="mainwp-may-hide-referrer" target="_blank"><?php echo htmlentities( $recent_pages_draft[ $i ]['title'], ENT_COMPAT | ENT_HTML401, 'UTF-8' ); ?></a></span>
						<span class="mainwp-cols-10">
			...
			<div class="recent_posts_pending" style="display: none">
				...
				for ( $i = 0; $i < count( $recent_pages_pending ) && $i < 5; $i ++ ) {
					...
					<div class="mainwp-row mainwp-recent">
						...
						<span class="mainwp-left mainwp-cols-2"><a href="<?php echo esc_url($recent_pages_pending[ $i ]['website']->url); ?>?p=<?php echo esc_attr($recent_pages_pending[ $i ]['id']); ?>" target="_blank" class="mainwp-may-hide-referrer"><?php echo htmlentities( $recent_pages_pending[ $i ]['title'], ENT_COMPAT | ENT_HTML401, 'UTF-8' ); ?></a></span>
	                    <span class="mainwp-cols-10">
				...
				for ( $i = 0; $i < count( $recent_pages_future ) && $i < 5; $i ++ ) {
					...
					<div class="mainwp-row mainwp-recent">
						...
						<span class="mainwp-left mainwp-cols-2"><a href="<?php echo esc_url($recent_pages_future[ $i ]['website']->url); ?>?p=<?php echo esc_attr($recent_pages_future[ $i ]['id']); ?>" target="_blank" class="mainwp-may-hide-referrer"><?php echo htmlentities( $recent_pages_future[ $i ]['title'], ENT_COMPAT | ENT_HTML401, 'UTF-8' ); ?></a></span>
                                                <span class="mainwp-cols-10">
