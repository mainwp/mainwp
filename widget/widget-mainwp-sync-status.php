...
class MainWP_Sync_Status {
	...
	public static function getName() {
		return '<i class="fa fa-pie-chart"></i> ' . __( 'Sync Status', 'mainwp' );
	}

	public static function render() {
		?>
		<div id="rightnow_list" xmlns="http://www.w3.org/1999/html"><?php MainWP_Sync_Status::renderSites(); ?></div>
		<?php
	}
	...
	?>
		...
		<div class="clear">			
			<div id="wp_syncs">
				...
				if ($all_sites_synced) {
					esc_html_e( "All sites synced.", 'mainwp' );
				}
				?>
			</div>
		</div>
